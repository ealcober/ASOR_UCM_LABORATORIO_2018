...
int main(int argc, char const *argv[])
{
    ...
    t1 = open("../tuberia", O_RDWR | O_NONBLOCK); //o_rdwr truco que evita que haga un read 0 ya que abriéndolo
    //como lector siempre vamos a estar conectados a la tubería
    t2 = open("../tuberia2", O_RDWR | O_NONBLOCK);
